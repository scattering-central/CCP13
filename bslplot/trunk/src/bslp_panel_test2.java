...
public class bslp_panel_test2 extends JPanel 
  {
  int Error = 0; // default state 

  private Vector PlotVector;
  private Vector FullPointPlotVector;
  ...
  public bslp_panel_test2 ()
    ...
    CreateFullPointCurve fpc = new CreateFullPointCurve (PlotVector);
    FullPointPlotVector = fpc.getFullPointCurve() ;
    }
