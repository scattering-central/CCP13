...
int iffr, ilfr, ifinc;\
int filenum;\
int npix, nrast, nframe, fendian, dtype;\
vfptr ok_function;
*obFileSelect.ispeclist: selection, filelist, filtertxt, filename, iffr, ilfr, ifinc, filenum, npix, nrast, nframe, fendian, dtype, ok_function
...
*obFileSelect.ispeclist.fendian: "int", "%fendian%"
*obFileSelect.ispeclist.dtype: "int", "%dtype%"
...
*obFileSelect_readHeader.arguments: file, mem, np, nr, nf, ne, nd
...
*obFileSelect_readHeader.ne.def: "int", "*%ne%"
*obFileSelect_readHeader.nd.def: "int", "*%nd%"
