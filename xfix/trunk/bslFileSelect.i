...
*bslFileSelect_readHeader.arguments: file, mem, npixel, nraster, nframes, fend, dtyp
...
*bslFileSelect_readHeader.fend.def: "int", "*%fend%"
*bslFileSelect_readHeader.dtyp.def: "int", "*%dtyp%"
...
*bslFileSelect.x.value: 595
*bslFileSelect.y.value: 121
