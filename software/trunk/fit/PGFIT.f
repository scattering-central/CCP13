...
C
C Calls  11: GETHDR , OPNFIL , OUTFIL , OPNNEW , ASKERR , PAPER ,
...
C
      INTEGER MAXFRM
      PARAMETER (MAXFRM = 10*(MAXPAR/3 + 1))
...
C
      REAL O2BUF(MAXDIM,MAXFRM),O1BUF(MAXDIM)
