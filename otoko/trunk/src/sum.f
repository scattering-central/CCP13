...
C
      ...
      IMPLICIT NONE
C
C Purpose: Calculate the sum of a multiple set of data files for
C          all channels. Data set input sequence is terminated by
C          <ctrl-Z> for VMS/<ctrl-D> for unix
C
      INCLUDE 'COMMON.FOR'
C
...
C
      ...
      INTEGER KREC,ISPEC,LSPEC,MEM,IFFR,ILFR,INCR,IFINC,NFRAME,I,J,K
...
C ICOUNT : Number of frames summed
C
      DATA  IMEM/1/ , KREC/1/ , ICLO/1/
C
C-----------------------------------------------------------------------
10    JOP=0
      ICOUNT=0      
