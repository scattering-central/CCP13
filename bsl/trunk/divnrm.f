...
C
      ...
      IMPLICIT NONE
C
C Purpose: Divide and normalise image in a region of interest with a
...
C
     ...
     &                NRAST2,NFRAM2,IRC)
         ...
         ISPEC2=ISPEC2+INCR2
C
cx         CALL RFRAME (JUNIT,IFFR1,NPIX1,NRAST1,SP1,IRC)
...
C
         DO 60 J=1,IFRMX2
            ...
            KPIC=KPIC+1
C
            print *,'Using normalisation value ',sp1(iffr2)
            IF (SP1(IFFR2).LE.0.0) THEN
